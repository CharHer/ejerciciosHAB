...
public class OficinaJpaController implements Serializable {
    ...
    public void create(Oficina oficina) { //REVISAR POR QUE EL IDE GENERA UN CODIGO DIFERENTE A ESTE
        EntityManager em = null;            //GENERA EL FALLO AL SER OBJETO DE LA ANOTACION CASCADE
        try {
            em = getEntityManager();
